...
public class Stat {
    ...
    // Chi Square distribution - assumes normal distribution (of what?!?!?)

    // sums together all (observed - expected values)/ expected value
    ...
    //TODO: what do we think is a "good" estimate? for the purposes of the paper, this threshold would likely need to be determined via testing.
